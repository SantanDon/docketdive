        ...
        <div className="flex items-center gap-2">
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button variant="secondary" size="sm" className="h-9 gap-2 bg-amber-100 hover:bg-amber-200 text-amber-900 border-amber-200">
                        <GraduationCap className="h-4 w-4" />
                ...
                <DropdownMenuContent align="end" className="w-56">
                    <DropdownMenuItem onClick={() => setEliLevel("ELI5")} className="hover:!bg-green-50 focus:!bg-green-50">
                     ...
                     <DropdownMenuItem onClick={() => setEliLevel("ELI15")} className="hover:!bg-green-50 focus:!bg-green-50">
                         <div className="flex flex-col gap-1">
                     ...
                     <DropdownMenuItem onClick={() => setEliLevel("ELI25")} className="hover:!bg-green-50 focus:!bg-green-50">
                         <div className="flex flex-col gap-1">
